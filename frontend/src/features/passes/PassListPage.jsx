...
function passFilter(draft, setDraft) {
...
export function PassListPage() {
  return (
    <ListPage
      ...
      cacheKey={CACHE_KEY}
      endpoint="/api/access-passes/"
      tabs={TABS}
      emptyFilters={EMPTY_FILTERS}
      filterCount={countActive}
      renderFilter={({ draft, setDraft }) => passFilter(draft, setDraft)}
