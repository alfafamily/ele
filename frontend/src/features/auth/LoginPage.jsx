...
const YANDEX_ERROR_MESSAGES = {
  ...
  // B12: дубли сотрудников по Фамилии и Имени.
  duplicate_exists:
    'Сотрудник с такими Фамилией и Именем уже существует в системе. Возможно, вы уже создавали аккаунт ранее. Попробуйте восстановить пароль от вашего аккаунта.\n\nЕсли вы не создавали аккаунт ранее, обратитесь к вашему руководителю или системному администратору.',
  duplicate_ambiguous:
    'В системе зарегистрировано несколько сотрудников с вашими Фамилией и Именем. Для создания аккаунта обратитесь к вашему руководителю или системному администратору.',
}
      ...
      {yandexErrorParam ? (
        <Banner variant="error">
          <span style={{ whiteSpace: 'pre-line' }}>
            {YANDEX_ERROR_MESSAGES[yandexErrorParam] || 'Не удалось войти через Яндекс ID.'}
          </span>
        </Banner>
      ) : null}
      {formError ? (
