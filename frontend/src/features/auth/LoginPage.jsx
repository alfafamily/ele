...
const YANDEX_ERROR_MESSAGES = {
  ...
  duplicate_exists:
    'Сотрудник с такими Фамилией и Именем уже существует в системе. Возможно, вы уже создавали аккаунт ранее. Попробуйте восстановить пароль от вашего аккаунта. Если вы не создавали аккаунт ранее, обратитесь к вашему руководителю или системному администратору.',
  duplicate_ambiguous:
