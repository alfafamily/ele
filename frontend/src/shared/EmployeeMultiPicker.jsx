...
export function EmployeeMultiPicker({ value = [], onChange, extraParams, listMaxHeight }) {
  ...
  return (
    <div>
      ...
      <EmployeePicker onSelect={add} excludeIds={ids} withPlus extraParams={extraParams} listMaxHeight={listMaxHeight} />
    </div>
  )
}
