...
urlpatterns = [
    ...
    path(
        ...
        views.NotificationWindowView.as_view(),
        name="company-notification-settings",
    ),
    ...
    path("company/test-push/", views.CompanyTestPushView.as_view(), name="company-test-push"),
    path("company/verify-push/", views.CompanyVerifyPushView.as_view(), name="company-verify-push"),
